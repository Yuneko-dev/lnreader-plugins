...
- `@libs/utils`: added `utf8ToBytes`, `bytesToUtf8`, `Buffer`, `NodeCrypto` (Used similarly to `import NodeCrypto from "node:crypto"`), `encodeHtmlEntities` and `decodeHtmlEntities`
