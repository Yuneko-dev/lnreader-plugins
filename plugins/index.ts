...
import p_2 from '@plugins/vietnamese/akaytruyen';
import p_3 from '@plugins/vietnamese/AnimeVietsub';
import p_4 from '@plugins/vietnamese/BaoMoi';
import p_5 from '@plugins/vietnamese/doctruyenln';
import p_6 from '@plugins/vietnamese/hentaiz';
import p_7 from '@plugins/vietnamese/jukanovel';
...
import p_12 from '@plugins/vietnamese/mottruyen';
import p_13 from '@plugins/vietnamese/NguonC';
import p_14 from '@plugins/vietnamese/SangTacViet';
